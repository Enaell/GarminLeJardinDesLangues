...
class QuizModel {
    ...
    private function generateOptions() as Void {
        ...
        var correctTranslation = VocabularyData.getTranslation(currentWordIndex);
        options.add(correctTranslation);
        
        // Générer 3 distracteurs (traductions incorrectes)
        ...
        while (distractorIndices.size() < 3) {
            ...
            if (randomIndex != currentWordIndex && 
                ...
                var distractor = VocabularyData.getTranslation(randomIndex);
                
                // Éviter les doublons de traductions
